/**
 * Палітра Cuelume — 17 рецептів синтезу (тон / шум / shimmer).
 * Джерело: https://github.com/Danilaa1/cuelume
 */
...
export type CueSoundName = keyof typeof RECIPES;

export function isCueSoundName(value: unknown): value is CueSoundName {
  return typeof value === 'string' && Object.prototype.hasOwnProperty.call(RECIPES, value);
}

export const CUE_SOUNDS = Object.keys(RECIPES) as readonly CueSoundName[];
