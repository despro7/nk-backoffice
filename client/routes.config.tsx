...
import { lazyPage, type LazyPageComponent } from './lib/lazyPage';
...
const ReportsShipment = lazyPage(() => import('./pages/Reports/ReportsShipment'));
...
const SettingsProfile = lazyPage(() => import('./pages/SettingsProfile'));
const SettingsProductSets = lazyPage(() => import('./pages/SettingsProductSets'));
const ProductsPage = lazyPage(() => import('./pages/Products'));
const SettingsOrderAssembly = lazyPage(() => import('./pages/SettingsOrderAssembly'));
...
const BankStatementImport = lazyPage(() => import('./pages/BankStatementImport'));
const HrTimesheetPage = lazyPage(() => import('./pages/Hr/HrTimesheetPage'));
const HrPayrollPage = lazyPage(() => import('./pages/Hr/HrPayrollPage'));
const HrEmployeesPage = lazyPage(() => import('./pages/Hr/Employees'));
const HrEmployersPage = lazyPage(() => import('./pages/Hr/Employers'));
const HrPersonsPage = lazyPage(() => import('./pages/Hr/Persons'));
const HrBonusesPage = lazyPage(() => import('./pages/Hr/Bonuses'));
const HrFopPage = lazyPage(() => import('./pages/Hr/Fop'));
const TestSerialCom = lazyPage(() => import('./pages/test-serial-com'));
const MetaLogNotifications = lazyPage(() => import('./pages/MetaLogs'));
...
export interface NavBadge {
   ...
   */
  until?: string;
  /** Підказка при наведенні (напр. для числового лічильника) */
  tooltip?: string;
}
