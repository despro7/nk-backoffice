...
export const PERMISSION_SEEDS: Array<{ key: PermissionKey; seed: SeedGrant }> = [
  ...
  { key: pageKey('hr', 'persons'), seed: min(ROLES.BOSS) },
  { key: pageKey('hr', 'bonuses'), seed: min(ROLES.BOSS) },
  { key: pageKey('hr', 'fop'), seed: only(ROLES.ADMIN, ROLES.BOSS) },
  { key: actionKey('hr', 'timesheet.edit'), seed: min(ROLES.BOSS) },
  { key: actionKey('hr', 'employees.manage'), seed: min(ROLES.BOSS) },
  { key: actionKey('hr', 'persons.manage'), seed: min(ROLES.BOSS) },
  { key: actionKey('hr', 'audit.view'), seed: only(ROLES.ADMIN, ROLES.BOSS) },
  ...
  { key: actionKey('hr', 'taxrules.manage'), seed: only(ROLES.ADMIN, ROLES.BOSS) },
  { key: actionKey('hr', 'bonuses.manage'), seed: min(ROLES.BOSS) },
...
export const PERMISSIONS = {
  ...
  PAGE_HR_PERSONS: pageKey('hr', 'persons'),
  PAGE_HR_BONUSES: pageKey('hr', 'bonuses'),
  PAGE_HR_FOP: pageKey('hr', 'fop'),
  ACTION_HR_TIMESHEET_EDIT: actionKey('hr', 'timesheet.edit'),
  ACTION_HR_EMPLOYEES_MANAGE: actionKey('hr', 'employees.manage'),
  ACTION_HR_PERSONS_MANAGE: actionKey('hr', 'persons.manage'),
  ACTION_HR_AUDIT_VIEW: actionKey('hr', 'audit.view'),
  ACTION_HR_PAYROLL_VIEW: actionKey('hr', 'payroll.view'),
  ACTION_HR_PAYTERMS_MANAGE: actionKey('hr', 'payterms.manage'),
  ACTION_HR_TAXRULES_MANAGE: actionKey('hr', 'taxrules.manage'),
  ACTION_HR_BONUSES_MANAGE: actionKey('hr', 'bonuses.manage'),
