        ...
        <PresenceGate key="sheet">
          {({ gate }) => (
            <motion.div
              ...
              className={cn(
                "pointer-events-auto fixed bottom-0 left-0 right-0 z-50 mx-auto flex max-w-2xl flex-col overflow-hidden rounded-t-2xl will-change-transform",
