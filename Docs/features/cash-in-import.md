...
**Маршрут:** `/accounting/cash-in`  
**Дозвіл:** `page.accounting.cashIn`

## Призначення

Сторінка дозволяє завантажити Excel-реєстр переказів від НП та вивантажити документи **"Надходження грошей" (`documents.cashIn`)** у Діловод.

Кроки UI — спільний [`Timeline`](../architecture/timeline.md), пресет `amber`. Сусідній модуль без прив’язки до замовлень: [банківські виписки](./bank-statement-import.md).
