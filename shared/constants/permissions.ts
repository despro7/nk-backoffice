...
export const PERMISSION_SEEDS: Array<{ key: PermissionKey; seed: SeedGrant }> = [
  ...
  { key: pageKey('warehouse', 'materials'), seed: min(ROLES.STOREKEEPER) },
  ...
  { key: actionKey('products', 'skuWhitelist'), seed: min(ROLES.BOSS) },
  { key: actionKey('products', 'setParentIds.read'), seed: min(ROLES.BOSS) },
  { key: actionKey('products', 'setParentIds.write'), seed: only(ROLES.ADMIN) },
  ...
  { key: actionKey('materials', 'edit'), seed: min(ROLES.STOREKEEPER) },
  { key: actionKey('materials', 'sync'), seed: min(ROLES.WAREHOUSE_MANAGER) },
  { key: actionKey('materials', 'parentIds'), seed: only(ROLES.ADMIN) },
...
export const PERMISSIONS = {
  ...
  PAGE_WAREHOUSE_MATERIALS: pageKey('warehouse', 'materials'),
  ...
  ACTION_PRODUCTS_SKU_WHITELIST: actionKey('products', 'skuWhitelist'),
  ACTION_PRODUCTS_SET_PARENT_IDS_READ: actionKey('products', 'setParentIds.read'),
  ACTION_PRODUCTS_SET_PARENT_IDS_WRITE: actionKey('products', 'setParentIds.write'),
  ...
  ACTION_MATERIALS_EDIT: actionKey('materials', 'edit'),
  ACTION_MATERIALS_SYNC: actionKey('materials', 'sync'),
  ACTION_MATERIALS_PARENT_IDS: actionKey('materials', 'parentIds'),
